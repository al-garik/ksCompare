...
- Schema, Row matching, Unmatched rows, Columns with differences,
  Diff causes, Most-affected rows, Value differences, Patterns, and
  Manifest sections,
- a print-friendly stylesheet.

Pass `path = NA` to get the assembled `htmltools::tagList()` for
